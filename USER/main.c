...
// =====================================================================
// [3] 电脑与蓝牙串�? USART1 (PA9, PA10) - 绝�?�安全版
// =====================================================================
...
// =====================================================================
// [4] 云�??大脑串口 USART3 (PB10, PB11 连接 ESP8266) - 防溢出�?�甲�?
// =====================================================================
...
void USART3_IRQHandler(void) {
    if (USART_GetITStatus(USART3, USART_IT_RXNE) != RESET) {
        ...
        // 核心装甲：满 512 字节前允许存入，绝不越界踩踏�?带内存！
        if (g_esp8266_rx_cnt < ESP_BUF_SIZE - 1) {
            g_esp8266_rx_buf[g_esp8266_rx_cnt++] = d;
            g_esp8266_rx_buf[g_esp8266_rx_cnt] = '\0'; // 始终保持字�?�串结尾，方�? strstr 查找
        } else {
            g_esp8266_rx_end = 1; 
        }
